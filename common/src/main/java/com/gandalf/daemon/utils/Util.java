...
import com.suosa.daemonlib.BuildConfig;
...
public class Util {
    ...
    public static String getSDCardDir(Context context) {
        final String cachePath = Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ? Environment.getExternalStorageDirectory().getPath()
