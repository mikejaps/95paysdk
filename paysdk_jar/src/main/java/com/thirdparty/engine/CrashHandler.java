...
import com.gandalf.daemon.utils.Util;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public static String filepath = Util.getSDCardDir(AppAppllication.INSTANCE) + XL_log.LOG_PATH_NAME;// 存储路径
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            AppAppllication.INSTANCE.killSelf();
...
//        if (mContext == null)
//            return;
//        DaemonManager m = DaemonManager.getInstance(mContext);
//        String logConent = m.getRunlogContent();
//        if (logConent == null)
//            return;
