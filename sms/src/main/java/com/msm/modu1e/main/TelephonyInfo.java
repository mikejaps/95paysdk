	...
	public static TelephonyInfo getInstance(Context context) {
		...
		if (telephonyInfo == null) {
			...
			try {
				...
				telephonyInfo.imsiSIM2 = getDeviceIdBySlot(context, "getDeviceIdGemini", 1);//getSubscriberIdGemini
			} catch (GeminiMethodNotFoundException e) {
				e.printStackTrace();

				try {
					telephonyInfo.imsiSIM1 = getDeviceIdBySlot(context, "getDeviceId", 0);//getSubscriberId
