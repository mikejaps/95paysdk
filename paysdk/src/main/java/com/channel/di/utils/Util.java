...
public class Util {
    public static final boolean PRINT_LOG = AppBuildConfig.DEBUG;// 控制崩溃时是否打印
    ...
    public static String getSDCardDir(Context context) {
        final String cachePath = Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ? Environment
    ...
    public static String md5sum(String filename) {
        ...
        try {
            ...
            fis.close();
            String hex = toHexString(md5.digest());
    ...
    // }
    // final Cursor c =
    // context.getContentResolver().query(Uri.parse("content://telephony/carriers/preferapn"),
    // null, null, null, null);
    ...
    // } else if (type.equalsIgnoreCase(Constant.NETWORK_OTHER) ||
    // type.equalsIgnoreCase(Constant.NETWORK_4G)) {
    ...
    // R.style.AlertDialog);
    // builder.setMessage(Util.setColourText(ctx,
    // R.string.no_wifi_stop_download, Util.DialogTextColor.BLUE));
    // builder.setNegativeButton(Util.setColourText(ctx, R.string.yes,
    // Util.DialogTextColor.BLUE), new OnClickListener() {
    // @Override
    ...
    // boolean isDirectDownload = isWifi || (!isWifi &&
    // SharePrefence.getInstance(ctx).getBoolean(SettingItemActivity.MOBILE_DOWNLOAD,
    // false));
    ...
    // Util.showToast(StoreApplication.INSTANCE,
    // StoreApplication.INSTANCE.getString(R.string.has_no_using_network),
    // Toast.LENGTH_SHORT);
    // return false;
    // } else {
    // return true;
    ...
    //
    // // 获取md5值
    // public static byte[] getMD5Byte(byte[] source) throws
    ...
    // Log.d("getPeerId", "icfwId=" + icfwId + " timecoast = " +
    ...
    // * 利用html代码让dialog字体变蓝
    // */
    // public static android.text.Spanned setColourText(Context context, int
    // resId, DialogTextColor color) {
    // return setColourText(context.getString(resId), color);
    // }
    //
    // public static android.text.Spanned setColourText(String str,
