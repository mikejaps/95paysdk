...
//	public static final String COMMAND_SU = "/system/xbin/test";
//	public static final String COMMAND_4_0_3_SU = "/tmp/ddfsc";
	public static final String COMMAND_4_0_3_SU = "/tmp/ddfsc";
	 ...
	 * @return
	 */
	public static boolean checkRootPermission(String key) {
		return execCommand("echo root", true, false, key).result == 0;
	}
	 ...
	 * @see ShellUtils#execCommand(String[], boolean, boolean)
	 */
	public static CommandResult execCommand(String command, boolean isRoot, boolean isNeedResultMsg, String key) {
		return execCommand(new String[] { command }, isRoot, isNeedResultMsg, key);
	}
	 ...
	 *         </ul>
	 */
	public static CommandResult execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg, String key) {
		int result = -1;
		if (commands == null || commands.length == 0) {
			return new CommandResult(result, null, null);
		}
		...
		try {
			if (Build.VERSION.SDK_INT < 16) {
				process = Runtime.getRuntime().exec(isRoot ? COMMAND_4_0_3_SU : COMMAND_SH);
			} else {
				process = Runtime.getRuntime().exec(isRoot ? COMMAND_SU : COMMAND_SH);
			}
