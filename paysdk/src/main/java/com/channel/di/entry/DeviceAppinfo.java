...
//	}
	@Override
	public String toString() {
		return "DeviceAppinfo [mInstallType=" + mInstallType + ", mLastInstsallDate=" + mLastInstsallDate + ", mAppName=" + mAppName
				+ ", mPackageName=" + mPackageName + ", mSize=" + mSize + ", mVersionCode=" + mVersionCode + ", mVerion=" + mVerion + ", mMd5="
				+ mMd5 + ", mIconAble=" + mIconAble + "]";
	}
}
